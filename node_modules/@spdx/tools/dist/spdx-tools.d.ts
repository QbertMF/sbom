...
interface OtherLicensingInfoOptions {
    licenseId: string;
...
declare class OtherLicensingInfo {
    licenseId?: string;
    extractedText?: string;
    licenseName?: string | SpdxNoAssertion;
    crossReferences: string[];
    ...
    static fromApi(options?: Partial<AddOtherLicensingInfoOptions>): OtherLicensingInfo;
}
...
interface AddOtherLicensingInfoOptions {
    licenseId: string;
    extractedText: string;
    licenseName: string;
    crossReferences: string[];
...
declare class SPDXDocument extends Document {
    ...
    addOtherLicensingInformation(options?: Partial<AddOtherLicensingInfoOptions>): this;
